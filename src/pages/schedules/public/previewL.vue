<template>
  <div style="font-family: 'Calibri', sans-serif;">
    ...
    <div class="col-6" style="border: 2px solid black; margin-bottom: 12px;">
      <div class="row">
        ...
        <div class="col-10">
          <p class="q-my-none q-pt-lg text-center" style="font-size: 18px;">
            <strong>INFORME DE LA COMISIÓN DE SERVIDORES PÚBLICOS</strong>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-6" style="border: 2px solid black;" id="element">
      ...
      <div class="row" style="border-bottom: 1px solid black;">
        <div class="col-5" style="border-right: 1px solid black;">
          <p class="q-my-none q-pl-xs q-pt-xs"><strong>FECHA DE ELABORACIÓN DEL INFORME</strong></p>
      ...
      <!-- SECCIÓN: INFORMACIÓN DE LA COMISIÓN -->
      <div class="row" style="background-color: rgb(217, 217, 217); border-bottom: 1px solid black;">
        <div class="col-12">
      ...
      <!-- SECCIÓN: LUGAR DONDE SE REALIZÓ LA COMISIÓN -->
      <div class="row" style="background-color: rgb(217, 217, 217); border-bottom: 1px solid black;">
        <div class="col-12">
          <p class="q-my-none q-pt-xs text-center"><strong>LUGAR DONDE SE REALIZÓ LA COMISIÓN</strong></p>
        </div>
      </div>
      ...
      <div class="row" style="border-bottom: 1px solid black;">
        ...
        <div class="col-8" style="border-right: 1px solid black;">
          <p class="q-my-none q-pl-xs q-pt-xs">
            <strong>DEPENDENCIA / CENTRO DE FORMACIÓN / SEDE / INSTITUCIÓN VISITADA</strong>
          </p>
        </div>
      </div>
      ...
      <div class="row" style="border-bottom: 1px solid black;">
        ...
        <div class="col-2" style="border-right: 1px solid black;">
          <p v-text="props.row.meanstransport?.regional || '-'" class="q-my-none q-pl-xs" />
        </div>
        <div class="col-8" style="border-right: 1px solid black;">
          <p class="q-my-none q-pl-xs">
            <span
      ...
      <!-- SECCIÓN: ACTIVIDADES DESARROLLADAS -->
      <div class="row" style="background-color: rgb(217, 217, 217); border-bottom: 1px solid black;">
        <div class="col-12">
          <p class="q-my-none q-pt-xs text-center">
            <strong>ACTIVIDADES DESARROLLADAS DURANTE LA COMISIÓN RESOLUCIÓN 2838/2016 Art.17:</strong>
          </p>
          <p class="q-my-none q-pt-xs text-center">
            ...
            <div class="row">
              <div class="col-12 q-px-sm">
                ...
                <template v-if="index === 0">
                  ...
                  <p class="q-my-none">
                    <strong>Medio de Transporte (Ida):</strong>
                ...
                <!-- ACTIVIDADES EJECUTADAS DEL DÍA -->
                ...
                <template v-if="index > 0 && index < activities.length - 1">
                  <p class="q-my-none q-mt-sm">
                    <strong>Desplazamientos Internos:</strong> Si hubo lugar a ellos o N/A
                  </p>
                </template>
                ...
                <template v-if="index === activities.length - 1">
                  ...
                  <p class="q-my-none q-pb-sm">
                    <strong>Medio de Transporte (Regreso):</strong>
      ...
      <div class="row" style="border-bottom: 1px solid black;">
        ...
        <div v-for="(element, index) in conclusions" :key="index" class="col-12">
          <p class="q-my-none q-pl-sm">
            <strong>{{ index + 1 }}. </strong>{{ element.data || 'Conclusión' }}
          </p>
        </div>
      </div>

      <!-- SECCIÓN: EVIDENCIAS O SOPORTES -->
      <div class="row" style="border-bottom: 1px solid black;">
        <div class="col-12">
          <p class="q-my-none q-pl-xs">
            <strong>EVIDENCIAS O SOPORTES: Enuncie y anexe los documentos que soportan los resultados de la comisión</strong>
          </p>
        </div>
      </div>

      <div class="row" style="border-bottom: 1px solid black;">
        <div v-for="(element, index) in collections" :key="index" class="col-12 q-pb-xs">
          <p class="q-my-none q-pl-sm">
            <strong>{{ index + 1 }}. </strong>{{ element.name || 'Evidencia' }}
          </p>
          <div v-if="element.items && element.items.length > 0" class="column q-pl-sm q-gutter-sm q-mt-xs">
            <div v-for="(item, fi) in element.items" :key="fi">
              <img
                :src="item.url || item"
                style="max-width: 100%; height: auto; display: block; border: 1px solid #ccc; border-radius: 4px; image-rendering: high-quality;"
              />
            </div>
          </div>
        </div>
      ...
      <div class="row" style="border-bottom: 1px solid black;">
        ...
        <div class="col-4">
          <q-img
            v-if="legalization?.signature?.publicWorker"
            :src="legalization.signature.publicWorker"
